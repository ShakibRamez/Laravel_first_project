                                ...
                                <div class="basic-form">
                                    <form action="show" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control input-default" placeholder="Number" name="number">
                                        </div>
                                        <div class="form-group">
                                            <label for="">Date</label>
                                            <input type="text" class="form-control input-default" placeholder="Date" name="date">
                                        </div>
